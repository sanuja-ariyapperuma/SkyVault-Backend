...
public class SkyVaultPageModel(IAntiforgery antiForgery) : PageModel
{
    ...
    public string? SystemUserId { get; private protected set; }
    ...
    {
        SystemUserId = HttpContext.Session.GetString("Session.SystemUserId");
    ...
    {
        HttpContext.Session.SetString("Session.SystemUserId", SystemUserId!);
    ...
    {
        return SystemUserId is null || Upn is null || FullName is null || Email is null || Role is null;
    }
}